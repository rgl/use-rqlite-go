...
#      see https://github.com/kubernetes-sigs/kind/blob/v0.29.0/pkg/cluster/internal/providers/docker/network.go
...
#   rqlite/rqlite  1.16.0         8.43.0       The lightweight, distributed relational databas...
